...
function App() {
  return (
    <div className="relative h-screen w-screen overflow-y-auto overflow-x-hidden md:overflow-hidden bg-slate-200 dark:bg-zinc-950">
      ...
      <div className="container mx-auto relative flex items-center justify-center h-auto md:h-full py-6 px-4 md:px-6">
        <div className="max-w-7xl w-full flex flex-col md:flex-row gap-6 md:h-full">
          ...
          <div className="flex-1 bg-white w-full dark:bg-zinc-800 rounded-3xl md:rounded-r-3xl md:rounded-l-none shadow-2xl flex flex-col md:h-full border-blur relative">
            <div className="flex-1 overflow-x-hidden md:overflow-y-auto p-4 z-10 relative scrollbar-green max-w-full">
